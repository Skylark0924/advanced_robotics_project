...
if __name__ == '__main__':
    ...
    # panda arm
    panda_urdf_path_1 = os.path.join(pkg_path, 'robots/franka/urdf/panda_arm_hand_realsense_1.urdf')
    panda_urdf_path_2 = os.path.join(pkg_path, 'robots/franka/urdf/panda_arm_hand_realsense_2.urdf')
    panda_config_path_1 = os.path.join(pkg_path, 'robots/franka/config/panda_arm_hand_1.yaml')
    panda_config_path_2 = os.path.join(pkg_path, 'robots/franka/config/panda_arm_hand_2.yaml')
    robot_1 = Manipulator(verbose=True, urdf_path=panda_urdf_path_1, config_path=panda_config_path_1)
    robot_2 = Manipulator(verbose=True, urdf_path=panda_urdf_path_2, config_path=panda_config_path_2)
    print('robot_1 id:{}, type:{}'.format(robot_1.id, type(robot_1.id)))
    print('robot_2 id:{}, type:{}'.format(robot_2.id, type(robot_2.id)))
